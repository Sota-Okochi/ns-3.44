...
main(int argc, char* argv[])
{
    ...
    uint16_t gNbNum = 1; //基地局
    uint16_t ueNumPergNb = 2; // 基地局当たりの端末数
    bool logging = false;
     ...
     */
    NodeContainer ueLowLatContainer; //低遅延トラフィック
    NodeContainer ueVoiceContainer; //音声トラフィック
    ...
    // CCとは：Component Carrierの略で、無線通信の周波数帯域を分割するための技術です。
