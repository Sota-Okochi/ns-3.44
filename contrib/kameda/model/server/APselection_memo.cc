...
void APselection::cal_need_rt(){
    ...
    for(int i=0;i<terms;i++){
        ...
        else if(m_use_appli.at(i) == static_cast<int>(APConstants::AppType::ONLINE_GAME)){
            m_need.push_back(APConstants::ONLINE_GAME_REQUIRED_RTT);  //オンラインゲーム（RTT）
        }
    }
